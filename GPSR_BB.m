...
epsilon = 0.00000000000001; % add to make sure vector is long enough
...
%   epsilon=0;
   cont_factors = 10.^[(-epsilon+log10(firstTauFactor)):...
       log10(1/firstTauFactor)/(cont_steps-1):0];
   cont_factors = 10.^[0:log10(firstTauFactor)/(cont_steps-1): ...
       (epsilon*sign(log10(firstTauFactor))+log10(firstTauFactor))]; %   ):...
%                    log10(1/firstTauFactor)/(cont_steps-1):0]; 
    cont_factors = cont_factors(end:-1:1);

                
                
                % add epsilon to make sure we've got enough elements                
end
